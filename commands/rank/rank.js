                    ...
                    if(between(msgcount, levelRequirements[index], levelRequirements[++index])) {
                        const embed = new MessageEmbed()
                            ...
                            .addFields(
                                ...
                                { name: 'Next Level in:', value: `${Math.abs(levelRequirements[++index] - msgcount)}`, inline: true },
                                { name: 'Progress:', value: `${Math.floor((msgcount / levelRequirements[++index]) * 100)}% | ${msgcount}/${levelRequirements[++index]}`}
                            )
